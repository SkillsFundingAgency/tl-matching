...
{
    public class When_OpportunityRepository_GetEmployerReferrals_Is_Called_With_No_Cdf_Providers
    {
        private readonly EmployerReferralDto _result;

        public When_OpportunityRepository_GetEmployerReferrals_Is_Called_With_No_Cdf_Providers()
        {
            ...
            dbContext.Add(
                new ValidOpportunityBuilder()
                    .AddEmployer()
                    .AddReferrals(isSelectedForReferral: true, isCdfProvider: false)
                    .Build());
        ...
        public void Then_EmployerReferralDto_Fields_Are_As_Expected()
        {
            ...
            _result.WorkplaceDetails.Count().Should().Be(0);
        }
    }
}