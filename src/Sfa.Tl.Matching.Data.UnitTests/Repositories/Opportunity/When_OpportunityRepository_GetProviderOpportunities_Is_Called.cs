...
namespace Sfa.Tl.Matching.Data.UnitTests.Repositories.Opportunity
{
    public class When_OpportunityRepository_GetProviderOpportunities_Is_Called
    {
        ...
        [Fact]
        public void Then_OpportunityReferralDto_OpportunityId_Is_Returned() =>
            _result.First().OpportunityId.Should().Be(1);

        [Fact]
        public void Then_OpportunityReferralDto_ReferralId_Is_Returned() =>
            _result.First().ReferralId.Should().Be(1);

        [Fact]
        public void Then_OpportunityReferralDto_ProviderName_Is_Returned() =>
            _result.First().ProviderName.Should().BeEquivalentTo("ProviderName");

        [Fact]
        public void Then_OpportunityReferralDto_ProviderPrimaryContact_Is_Returned() =>
            _result.First().ProviderPrimaryContact.Should().BeEquivalentTo("PrimaryContact");

        [Fact]
        public void Then_OpportunityReferralDto_ProviderPrimaryContactEmail_Is_Returned() =>
            _result.First().ProviderPrimaryContactEmail.Should().BeEquivalentTo("primary@contact.co.uk");

        [Fact]
        public void Then_OpportunityReferralDto_ProviderSecondaryContactEmail_Is_Returned() =>
            _result.First().ProviderSecondaryContactEmail.Should().BeEquivalentTo("secondary@contact.co.uk");

        [Fact]
        public void Then_OpportunityReferralDto_ProviderVenuePostcode_Is_Returned() =>
            _result.First().ProviderVenuePostcode.Should().BeEquivalentTo("AA1 1AA");

        [Fact]
        public void Then_OpportunityReferralDto_RouteName_Is_Returned() =>
        ...
        [Fact]
        public void Then_OpportunityReferralDto_Placements_Is_Returned()
