...
{
    public class When_OpportunityRepository_GetProviderReferrals_Is_Called_With_Unselected_Items
    {
        ...
        public When_OpportunityRepository_GetProviderReferrals_Is_Called_With_Unselected_Items()
        {
            ...
            var opportunity = new ValidOpportunityBuilder()
                .AddEmployer()
                .AddReferrals() //Not completed, not selected
                .Build();
