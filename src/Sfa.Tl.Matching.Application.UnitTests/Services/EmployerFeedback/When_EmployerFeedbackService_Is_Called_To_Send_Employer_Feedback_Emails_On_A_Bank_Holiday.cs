        ...
        : IClassFixture<EmployerFeedbackFixture>
    {
            ...
            EmployerFeedbackFixture testFixture)
        {
            ...
            _dateTimeProvider
                ...
                .Returns(new DateTime(2019, 8, 12));
            _dateTimeProvider
            ...
            var employerFeedbackService = new EmployerFeedbackService(
                mapper, testFixture1.Configuration, testFixture1.Logger,
        ...
        [Fact]
        public void Then_OpportunityItemRepository_UpdateManyWithSpecifedColumnsOnly_Is_Not_Called()
        {
