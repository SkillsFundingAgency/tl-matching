...
{
    public class When_ProviderVenueService_Is_Called_To_Get_Venue_By_Id
    {
        ...
        public When_ProviderVenueService_Is_Called_To_Get_Venue_By_Id()
        {
            ...
            _result = providerVenueService.GetVenueAsync(ProviderVenueId).GetAwaiter().GetResult();
        }
