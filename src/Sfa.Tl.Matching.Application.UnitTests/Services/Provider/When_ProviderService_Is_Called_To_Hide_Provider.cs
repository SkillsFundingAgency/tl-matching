...
{
    public class When_ProviderService_Is_Called_To_Hide_Provider
    {
        private const int ProviderId = 1;

        private readonly IRepository<Domain.Models.Provider> _providerRepository;

        public When_ProviderService_Is_Called_To_Hide_Provider()
        {
            ...
            service.SetIsProviderEnabledForSearchAsync(ProviderId, false).GetAwaiter().GetResult();
        }
