...
{
    public class When_ProviderService_Is_Called_To_Get_A_Provider
    {
        ...
        public When_ProviderService_Is_Called_To_Get_A_Provider()
        {
            ...
            _result = service.GetProviderAsync(ProviderId).GetAwaiter().GetResult();
        }
