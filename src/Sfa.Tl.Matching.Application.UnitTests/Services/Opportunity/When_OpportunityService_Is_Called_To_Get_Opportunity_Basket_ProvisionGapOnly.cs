...
{
    public class When_OpportunityService_Is_Called_To_Get_Opportunity_Basket_ProvisionGapOnly
    {
        private readonly OpportunityBasketViewModel _result;
        private readonly IOpportunityRepository _opportunityRepository;

        public When_OpportunityService_Is_Called_To_Get_Opportunity_Basket_ProvisionGapOnly()
        {
            ...
            _opportunityRepository.GetOpportunityBasketAsync(1)
                .Returns(viewModel);
        ...
        {
            _result.Type.Should().Be(OpportunityBasketType.ProvisionGapSingle);
