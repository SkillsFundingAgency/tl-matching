...
{
    public class When_Employer_Service_Is_Called_To_Handle_Invalid_Employer_Created_Event
    {
        private readonly IRepository<Domain.Models.Employer> _employerRepository;
        private readonly IMessageQueueService _messageQueueService;

        public When_Employer_Service_Is_Called_To_Handle_Invalid_Employer_Created_Event()
        {
            ...
            var employerEventBase = CrmEmployerEventBaseBuilder.Build(false);
