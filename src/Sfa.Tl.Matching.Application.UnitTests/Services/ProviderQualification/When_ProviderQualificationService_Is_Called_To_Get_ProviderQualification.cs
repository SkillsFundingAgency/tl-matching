...
{
    public class When_ProviderQualificationService_Is_Called_To_Get_ProviderQualification
    {
        ...
        public When_ProviderQualificationService_Is_Called_To_Get_ProviderQualification()
        {
