    ...
    public class When_Validate_And_Parse_File_Is_Called_For_Invalid_File
    {
        ...
        public When_Validate_And_Parse_File_Is_Called_For_Invalid_File()
        {
            ...
            using (var stream = File.Open(filePath, FileMode.Open))
            {
                ...
                excelfileReader.ValidateAndParseFileAsync(new EmployerStagingFileImportDto
                {
        ...
        {
            _functionLogRepository.Received(1).CreateManyAsync(Arg.Is<List<FunctionLog>>(list =>
                list.Count == 1 &&
