...
{
    public class When_EmployerStaging_Row_Has_No_CompanyName : IClassFixture<EmployerStagingFileImportFixture>
    {
        private readonly EmployerStagingFileImportFixture _fixture;

        public When_EmployerStaging_Row_Has_No_CompanyName(EmployerStagingFileImportFixture fixture)
        {
            _fixture = fixture;
        }
