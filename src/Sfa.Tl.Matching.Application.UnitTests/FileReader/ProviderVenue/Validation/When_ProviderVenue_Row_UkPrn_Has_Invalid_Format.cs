...
{
    public class When_ProviderVenue_Row_UkPrn_Has_Invalid_Format : IClassFixture<ProviderVenueFileImportFixture>
    {
        private readonly ProviderVenueFileImportFixture _fixture;

        public When_ProviderVenue_Row_UkPrn_Has_Invalid_Format(ProviderVenueFileImportFixture fixture)
        {
            _fixture = fixture;
        }
