...
{
    public class When_LearningAimsReferenceStaging_Row_Has_No_SourceCreatedOn : IClassFixture<LearningAimsReferenceStagingFileImportFixture>
    {
        private readonly LearningAimsReferenceStagingFileImportFixture _fixture;

        public When_LearningAimsReferenceStaging_Row_Has_No_SourceCreatedOn(LearningAimsReferenceStagingFileImportFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public void Then_Validation_Result_Is_Not_Valid(string sourceCreatedOn)
        {
            ...
            validationResult.Errors[0].ErrorMessage.Should().Be($"'{nameof(LearningAimsReferenceStagingFileImportDto.SourceCreatedOn)}' - {ValidationErrorCode.MissingMandatoryData.Humanize()}");
        }
    }
}