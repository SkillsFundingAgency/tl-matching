...
{
    public class When_QualificationRoutePathMapping_Row_Has_No_Source : IClassFixture<QualificationRoutePathMappingFileImportValidationTestFixture>
    {
        private readonly ValidationResult _validationResult;
        
        public When_QualificationRoutePathMapping_Row_Has_No_Source(QualificationRoutePathMappingFileImportValidationTestFixture fixture)
        {
            fixture.Dto.Source = "";
