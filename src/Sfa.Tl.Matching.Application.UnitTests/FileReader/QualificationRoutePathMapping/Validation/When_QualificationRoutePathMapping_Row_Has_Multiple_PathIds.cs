...
{
    public class When_QualificationRoutePathMapping_Row_Has_Multiple_PathIds : IClassFixture<QualificationRoutePathMappingFileImportValidationTestFixture>
    {
        private readonly ValidationResult _validationResult;
        
        public When_QualificationRoutePathMapping_Row_Has_Multiple_PathIds(QualificationRoutePathMappingFileImportValidationTestFixture fixture)
        {
