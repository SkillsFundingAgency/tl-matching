...
{
    public class When_QualificationRoutePathMapping_Row_Has_No_Title : IClassFixture<QualificationRoutePathMappingFileImportValidationTestFixture>
    {
        private readonly ValidationResult _validationResult;


        public When_QualificationRoutePathMapping_Row_Has_No_Title(QualificationRoutePathMappingFileImportValidationTestFixture fixture)
        {
            fixture.Dto.Title = "";
