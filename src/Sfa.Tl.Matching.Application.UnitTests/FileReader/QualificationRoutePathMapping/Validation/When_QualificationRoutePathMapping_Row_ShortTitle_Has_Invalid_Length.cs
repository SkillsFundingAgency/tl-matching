...
{
    public class When_QualificationRoutePathMapping_Row_ShortTitle_Has_Invalid_Length : IClassFixture<QualificationRoutePathMappingFileImportValidationTestFixture>
    {
        private readonly ValidationResult _validationResult;

        public When_QualificationRoutePathMapping_Row_ShortTitle_Has_Invalid_Length(QualificationRoutePathMappingFileImportValidationTestFixture fixture)
        {
