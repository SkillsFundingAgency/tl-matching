...
{
    public class When_RoutePathMapping_Row_Has_No_ShortTitle : IClassFixture<QualificationRoutePathMappingFileImportValidationTestFixture>
    {
        private readonly ValidationResult _validationResult;

        public When_RoutePathMapping_Row_Has_No_ShortTitle(QualificationRoutePathMappingFileImportValidationTestFixture fixture)
        {
