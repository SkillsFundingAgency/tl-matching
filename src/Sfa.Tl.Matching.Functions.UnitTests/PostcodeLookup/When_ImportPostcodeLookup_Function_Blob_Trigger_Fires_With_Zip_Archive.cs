...
{
    public class When_ImportPostcodeLookup_Function_Blob_Trigger_Fires_With_Zip_Archive
    {
        private readonly IFileImportService<PostcodeLookupStagingFileImportDto> _fileImportService;
        private readonly IRepository<FunctionLog> _functionLogRepository;

        public When_ImportPostcodeLookup_Function_Blob_Trigger_Fires_With_Zip_Archive()
        {
