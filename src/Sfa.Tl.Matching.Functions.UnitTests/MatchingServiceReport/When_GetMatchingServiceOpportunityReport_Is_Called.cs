...
{
    public class When_GetMatchingServiceOpportunityReport_Is_Called
    {
        private readonly IRepository<FunctionLog> _functionLogRepository;
        private readonly IActionResult _result;

        public When_GetMatchingServiceOpportunityReport_Is_Called()
        {
            ...
            var mockDbSet = new MatchingServiceOpportunityReportBuilder()
                    .BuildList();

            var opportunityRepository = Substitute.For< IOpportunityRepository > ();
            opportunityRepository.GetMatchingServiceOpportunityReportAsync().Returns(mockDbSet);
            ...
            _result = matchingServiceReportFunctions.GetMatchingServiceOpportunityReportAsync(
                request,
                context,
                logger)
        ...
        public void Result_Should_Be_Of_Expected_Type()
        {
            ...
            jsonResult?.Value.Should().BeOfType(typeof(List<MatchingServiceOpportunityReport>));
        }
        ...
        {
            var jsonResult = _result as JsonResult;
            var result = jsonResult?.Value as List<MatchingServiceOpportunityReport>;
