...
{
    public class When_ContactUpdatedHandlerAsync_Function_Http_Trigger_Is_Called
    {
        ...
        public When_ContactUpdatedHandlerAsync_Function_Http_Trigger_Is_Called()
        {
            ...
            employerFunctions.ContactUpdatedHandlerAsync(
                    request,
        ...
        [Fact]
        public void HandleContactUpdatedAsync_Is_Called_Exactly_Once_With_Expected_Payload()
        {
            _employerService
                .Received(1)
                .HandleContactUpdatedAsync(Arg.Is<string>(s => s == RequestBody));
        }
