...
{
    public class When_EmployerUpdatedHandlerAsync_Function_Http_Trigger_Is_Called
    {
        ...
        public When_EmployerUpdatedHandlerAsync_Function_Http_Trigger_Is_Called()
        {
            ...
            employerFunctions.EmployerUpdatedHandlerAsync(
                    request,
        ...
        [Fact]
        public void HandleEmployerUpdatedAsync_Is_Called_Exactly_Once_With_Expected_Payload()
        {
            _employerService
                .Received(1)
                .HandleEmployerUpdatedAsync(Arg.Is<string>(s => s == RequestBody));
        }
