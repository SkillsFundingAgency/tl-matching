...
namespace Sfa.Tl.Matching.Web.UnitTests.Mappers.DataUploadDto
{
    public class When_ViewModel_Is_Populated_Successfully
    {
        ...
        //    Assert.Equal((int)DataImportType.Employer, _viewModel.DataImportTypeViewModels[0].Id);

        //[Fact]
        //public void Then_Data_Import_Type_Enum_Name_Is_Mapped_Correctly() =>
        //    Assert.Equal(DataImportType.Employer.ToString(), _viewModel.DataImportTypeViewModels[0].Name);
    }
}