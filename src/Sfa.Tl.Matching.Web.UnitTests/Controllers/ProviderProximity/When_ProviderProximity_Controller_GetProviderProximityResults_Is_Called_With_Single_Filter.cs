...
{
    public class When_ProviderProximity_Controller_GetProviderProximityResults_Is_Called_With_Single_Filter
    {
        private readonly IActionResult _result;
        private readonly IProviderProximityService _providerProximityService;
        private const string Postcode = "CV1 2WT";

        public When_ProviderProximity_Controller_GetProviderProximityResults_Is_Called_With_Single_Filter()
        {
            ...
            _result = providerProximityController.GetProviderProximityResults($"{Postcode}-Route 1")
        ...
        public void Then_ViewModel_Should_Have_Expected_Values()
        {
            ...
            viewModel.SearchParameters.SelectedFilters.Count.Should().Be(1);
