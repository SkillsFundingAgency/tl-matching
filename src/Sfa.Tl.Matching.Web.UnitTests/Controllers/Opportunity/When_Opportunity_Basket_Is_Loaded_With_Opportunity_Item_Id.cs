...
{
    public class When_Opportunity_Basket_Is_Loaded_With_Opportunity_Item_Id
    {
        private readonly IOpportunityService _opportunityService;
        private readonly IActionResult _result;

        public When_Opportunity_Basket_Is_Loaded_With_Opportunity_Item_Id()
        {
            ...
            _result = controllerWithClaims.GetOpportunityBasketAsync(1, 2).GetAwaiter().GetResult();
        }
