...
namespace Sfa.Tl.Matching.Web.UnitTests.Controllers.Opportunity
{
    public class When_Opportunity_Controller_Save_ProvisionGap_Update_Opportunity
    {
        ...
        public When_Opportunity_Controller_Save_ProvisionGap_Update_Opportunity()
        {
            ...
            _result = controllerWithClaims.SaveProvisionGap(new SaveProvisionGapViewModel { SearchResultProviderCount = 0, SelectedRouteId = 1, Postcode = "cv12wt", SearchRadius = 10 }).GetAwaiter().GetResult();
        }
