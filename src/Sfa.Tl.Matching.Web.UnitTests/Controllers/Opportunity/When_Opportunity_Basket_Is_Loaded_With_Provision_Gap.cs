...
{
    public class When_Opportunity_Basket_Is_Loaded_With_Provision_Gap
    {
        private readonly IOpportunityService _opportunityService;
        private readonly IActionResult _result;

        public When_Opportunity_Basket_Is_Loaded_With_Provision_Gap()
        {
        ...
        public void Then_Result_Is_Correct()
        {
            ...
            viewModel.OpportunityItemId.Should().Be(10);
        }
