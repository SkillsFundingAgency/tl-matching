...
{
    public class When_Dashboard_Controller_Start_Is_Loaded_With_Service_Online_Status : IClassFixture<DashboardControllerFixture>
    {
        private readonly DashboardControllerFixture _fixture;
        private readonly IActionResult _result;
        
        public When_Dashboard_Controller_Start_Is_Loaded_With_Service_Online_Status(DashboardControllerFixture fixture)
        {
            _fixture = fixture;
