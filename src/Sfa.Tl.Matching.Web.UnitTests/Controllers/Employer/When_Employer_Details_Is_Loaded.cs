...
{
    public class When_Employer_Details_Is_Loaded : IClassFixture<EmployerControllerFixture<EmployerDetailDto, EmployerDetailsViewModel>>
    {
        private readonly EmployerControllerFixture<EmployerDetailDto, EmployerDetailsViewModel> _fixture;
        private readonly IActionResult _result;

        public When_Employer_Details_Is_Loaded(EmployerControllerFixture<EmployerDetailDto, EmployerDetailsViewModel> fixture)
        {
            _fixture = fixture;
            ...
            _result = _fixture.Sut.GetEmployerDetailsAsync(_fixture.OpportunityId, _fixture.OpportunityItemId).GetAwaiter().GetResult();
        }
