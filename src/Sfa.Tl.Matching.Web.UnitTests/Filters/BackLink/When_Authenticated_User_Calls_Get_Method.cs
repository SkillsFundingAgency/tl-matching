...
{
    public class When_Authenticated_User_Calls_Get_Method
    {
        private readonly INavigationService _navigationService;

        public When_Authenticated_User_Calls_Get_Method()
        {
            var defaultHttpContext = Substitute.For<HttpContext>();

            defaultHttpContext.User.Identity!.IsAuthenticated.Returns(true);
            defaultHttpContext.Request.Method.Returns("GET");
        ...
        [Fact]
        public async Task Then_NavigationService_AddCurrentUrlAsync_Is_Called()
        {
