...
{
    public class When_Cancel_Component_Is_Loaded_With_Saved_Opportunities
    {
        private readonly IOpportunityService _opportunityService;
        private readonly IViewComponentResult _result;

        public When_Cancel_Component_Is_Loaded_With_Saved_Opportunities()
        {
            _opportunityService = Substitute.For<IOpportunityService>();
            _opportunityService.GetSavedOpportunityItemCountAsync(1).Returns(1);
        ...
        public void Then_ViewComponentResult_Has_Expected_Values()
        {
            ...
            viewModel.CancelText.Should().Be("Go back to all opportunities");
        }
    }
}