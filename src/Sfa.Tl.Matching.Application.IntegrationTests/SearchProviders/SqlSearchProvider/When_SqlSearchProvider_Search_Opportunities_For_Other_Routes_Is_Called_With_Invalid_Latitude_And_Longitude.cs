...
{
    public class When_SqlSearchProvider_Search_Opportunities_For_Other_Routes_Is_Called_With_Invalid_Latitude_And_Longitude
    {
        ...
        {
            Action action = () => _provider.SearchOpportunitiesForOtherRoutesByPostcodeProximityAsync(new OpportunityProximitySearchParametersDto { Postcode = "CV1 2WT", SearchRadius = 5, SelectedRouteId = 7, Latitude = "", Longitude = "" }).GetAwaiter().GetResult();
