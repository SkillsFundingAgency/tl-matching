...
{
    public class When_SqlSearchProvider_Search_Is_Called_With_Invalid_Latitude_And_Longitude
    {
        private readonly Data.SearchProviders.SqlSearchProvider _provider;

        public When_SqlSearchProvider_Search_Is_Called_With_Invalid_Latitude_And_Longitude()
        {
