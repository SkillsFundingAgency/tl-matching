...
{
    public class When_SqlSearchProvider_Search_Opportunities_Is_Called_With_Valid_Postcode_But_No_Provider_For_Selected_Route : IDisposable
    {
        private readonly IEnumerable<SearchResultsViewModelItem> _results;
        private readonly MatchingDbContext _dbContext;
        private readonly ProviderVenue _providerVenue;

        public When_SqlSearchProvider_Search_Opportunities_Is_Called_With_Valid_Postcode_But_No_Provider_For_Selected_Route()
        {
            ...
            _results = provider.SearchOpportunitiesByPostcodeProximityAsync(new OpportunityProximitySearchParametersDto { Postcode = "MK1 1AD", SearchRadius = 5, SelectedRouteId = 1, Latitude = "52.010709", Longitude = "-0.736412" }).GetAwaiter().GetResult();
        }
