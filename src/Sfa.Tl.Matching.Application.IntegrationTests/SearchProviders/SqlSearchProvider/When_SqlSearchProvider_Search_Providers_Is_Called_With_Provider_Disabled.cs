...
{
    public class When_SqlSearchProvider_Search_Providers_Is_Called_With_Provider_Disabled : IDisposable
    {
        ...
        public When_SqlSearchProvider_Search_Providers_Is_Called_With_Provider_Disabled()
        {
