...
namespace Sfa.Tl.Matching.Application.IntegrationTests.SearchProviders.SqlSearchProvider
{
    public class When_SqlSearchProvider_Search_Other_Routes_Is_Called_With_Invalid_Latitude_And_Longitude
    {
        ...
        {
            Action action = () => _provider.SearchProvidersForOtherRoutesByPostcodeProximityAsync(new ProviderSearchParametersDto { Postcode = "CV1 2WT", SearchRadius = 5, SelectedRouteId = 7, Latitude = "", Longitude = "" }).GetAwaiter().GetResult();
