...
{
    public class When_ProviderQualification_Imports_File_With_Invalid_Format : IClassFixture<ProviderQualificationTestFixture>
    {
        private const string DataFilePath = @"ProviderQualification\ProviderQualification-InvalidFormat.xlsx";
