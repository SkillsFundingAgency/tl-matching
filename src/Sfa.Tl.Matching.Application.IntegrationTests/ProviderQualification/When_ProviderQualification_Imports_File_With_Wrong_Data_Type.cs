...
{
    public class When_ProviderQualification_Imports_File_With_Wrong_Data_Type : IClassFixture<ProviderQualificationTestFixture>
    {
        private const string DataFilePath = @"ProviderQualification\ProviderQualification-WrongDataType.xlsx";
