...
{
    public class When_OpportunityProximity_Controller_FindProviders_Is_Called_With_Invalid_Postcode : IClassFixture<OpportunityProximityControllerFixture>
    {
        private readonly OpportunityProximityControllerFixture _fixture;
        private readonly IActionResult _result;

        public When_OpportunityProximity_Controller_FindProviders_Is_Called_With_Invalid_Postcode(OpportunityProximityControllerFixture fixture)
        {
            _fixture = fixture;
            ...
            fixture.RoutePathService.GetRouteSelectListItemsAsync().Returns(routes);
