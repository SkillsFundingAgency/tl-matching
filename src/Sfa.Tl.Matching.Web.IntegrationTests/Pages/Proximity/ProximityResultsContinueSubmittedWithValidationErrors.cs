...
{
    public class ProximityResultsContinueSubmittedWithValidationErrors : IClassFixture<CustomWebApplicationFactory<TestStartup>>
    {
        ...
        public ProximityResultsContinueSubmittedWithValidationErrors(CustomWebApplicationFactory<TestStartup> factory)
        {
            _factory = factory;
        }
