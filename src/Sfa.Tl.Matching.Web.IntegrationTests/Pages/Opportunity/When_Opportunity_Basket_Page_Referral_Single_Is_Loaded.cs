...
{
    public class When_Opportunity_Basket_Page_Referral_Single_Is_Loaded : IClassFixture<CustomWebApplicationFactory<InMemoryStartup>>
    {
        ...
        public When_Opportunity_Basket_Page_Referral_Single_Is_Loaded(CustomWebApplicationFactory<InMemoryStartup> factory)
        {
            _factory = factory;
        }
        ...
        public async Task Then_Correct_Response_Is_Returned()
        {
            ...
            basketTableBody.Rows[0].Cells[3].TextContent.Should().Be("Venue 1 Name (CV1 2WT)");
