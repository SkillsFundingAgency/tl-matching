...
{
    public class OpportunityBasketPageReferralSingleLoaded : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        public OpportunityBasketPageReferralSingleLoaded(CustomWebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        }
