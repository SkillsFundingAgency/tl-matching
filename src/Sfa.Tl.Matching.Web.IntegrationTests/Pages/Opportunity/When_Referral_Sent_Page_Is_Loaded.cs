...
{
    public class When_Referral_Sent_Page_Is_Loaded : IClassFixture<CustomWebApplicationFactory<InMemoryStartup>>
    {
        ...
        public When_Referral_Sent_Page_Is_Loaded(CustomWebApplicationFactory<InMemoryStartup> factory)
        {
            _factory = factory;
        }
        ...
        public async Task Then_Correct_Response_Is_Returned()
        {
            ...
            crmLink.Href.Should().Be("https://esfa-cs-prod.crm4.dynamics.com/main.aspx?pagetype=entityrecord&etc=1&id=%7b11111111-1111-1111-1111-111111111111%7d&extraqs=&newWindow=true");
