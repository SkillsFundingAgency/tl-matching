...
{
    public class When_OpportunityProximity_Results_Continue_Submitted_With_Validation_Errors : IClassFixture<CustomWebApplicationFactory<InMemoryStartup>>
    {
        ...
        public When_OpportunityProximity_Results_Continue_Submitted_With_Validation_Errors(CustomWebApplicationFactory<InMemoryStartup> factory)
        {
            _factory = factory;
        }
