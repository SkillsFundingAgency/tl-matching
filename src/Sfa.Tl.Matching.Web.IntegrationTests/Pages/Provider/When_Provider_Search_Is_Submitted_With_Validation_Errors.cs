...
{
    public class When_Provider_Search_Is_Submitted_With_Validation_Errors : IClassFixture<CustomWebApplicationFactory<InMemoryStartup>>
    {
        private readonly CustomWebApplicationFactory<InMemoryStartup> _factory;

        public When_Provider_Search_Is_Submitted_With_Validation_Errors(CustomWebApplicationFactory<InMemoryStartup> factory)
        {
            _factory = factory;
        }
