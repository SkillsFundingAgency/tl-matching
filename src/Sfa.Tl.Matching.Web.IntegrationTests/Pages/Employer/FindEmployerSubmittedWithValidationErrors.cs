...
{
    public class FindEmployerSubmittedWithValidationErrors : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        public FindEmployerSubmittedWithValidationErrors(CustomWebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        }
